...
<div id="page-title">
    <h2>Dashboard</h2>
    <p>Welcome to the English Gang Administrative Portal.</p>
</div>
...
<div class="row">
    ...
    <div class="col-md-4">
        ...
        <div class="content-box bg-white post-box">
            <textarea name="" class="textarea-autosize" placeholder="Post a message on the teachers portal"></textarea>
            <div class="button-pane">
        ...
        <div class="content-box bg-white post-box">
            <textarea name="" class="textarea-autosize" placeholder="Post a message on the student portal"></textarea>
            <div class="button-pane">
