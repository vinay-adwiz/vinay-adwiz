...
jQuery(function ($) {
    $(".sidebar-submenu ul a")
        .click(function(e) {
            ...
            var div = li.parent("div");
            
            var item = div.parent("li");
            
            if (item.hasClass("active")) {
                item.removeClass("active").children("div").css("display","none");
                item.removeClass("active").children("div").removeClass("open-div");
            } else {
                item.addClass("active").children("div").css("display","block");
                item.addClass("active").children("div").addClass("open-div");
            }
