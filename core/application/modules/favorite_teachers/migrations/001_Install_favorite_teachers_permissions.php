...
class Migration_Install_favorite_teachers_permissions extends Migration
{
	/**
	...
	private $permissionValues = array(
		array(
			'name' => 'Favorite_teachers.Settings.Create',
			'description' => 'Create Favorite_teachers Settings',
			'status' => 'active',
		),
		array(
			'name' => 'Favorite_teachers.Settings.Delete',
			'description' => 'Delete Favorite_teachers Settings',
			'status' => 'active',
		),
    );
