...
class Migration_Install_curriculum_permissions extends Migration
{
	/**
	...
	private $permissionValues = array(
		array(
			'name' => 'Curriculum.Content.View',
			'description' => 'View Curriculum Content',
			'status' => 'active',
		),
		array(
			'name' => 'Curriculum.Content.Create',
			'description' => 'Create Curriculum Content',
			'status' => 'active',
		),
		array(
			'name' => 'Curriculum.Content.Edit',
			'description' => 'Edit Curriculum Content',
			'status' => 'active',
		),
		array(
			'name' => 'Curriculum.Content.Delete',
			'description' => 'Delete Curriculum Content',
			'status' => 'active',
		),
    );
