...
Route::any('profiles/teachers', 'users/view_teachers');
Route::any('profiles/teacher/(:any)', 'users/teacher/$1');

Route::any('class/feedback/(:any)', 'class_schedules/feedback/$1');

Route::any('subscription/response/(:any)', 'student_subscriptions/response/$1');
Route::any('subscription/2c2p/response', 'student_subscriptions/response_2c2p');
Route::any('subscription/alipay/response', 'student_subscriptions/response_alipay');
Route::any('referrals/(:any)', 'home/referrals/$1');
